# designer-leash-letters Specification

## Purpose

Paridad de personalización entre collar y correa en `/disenar`: ambos productos permiten letras y emojis del catálogo activo.
